...
trait ApiPlatformCollectionProviderTrait
{
    ...
    {
        return new class($paginator, $callback, $this) extends AbstractPaginator {
            public function __construct(Paginator $paginator, private readonly Closure $callback, private readonly object $callbackNewThis)
            {
